    ...
    public String toString(String comparetype) {
        ...
        if (null == comparetype) {
            ...
            return switch (comparetype) {
                case "v" ->
                    "The " + getClass().getName() + " has a Volume of: " + decimalFormat.format(calcVolume());
                case "h" ->
                    "The " + getClass().getName() + " has a Height of: " + getHeight();
                case "a" ->
                    "The " + getClass().getName() + " has a Base Area of: " + decimalFormat.format(calcBaseArea());
                default ->
                    "This is not a valid parameter to sort by, Please try again!";
            };
        }
    }
}
